...
# TAX_RATE = 0.22                             # 법인세율 22% (제거됨 - SPC 구조로 과세 이연)
...
class SolarPFModel:
    ...
    def pv_engine(self, status, time_t, curtail_today=False):
        ...
        # 영업이익 (법인세 제거 - SPC 구조로 과세 이연)
        operating_income = monthly_revenue - OPEX_MONTHLY - monthly_interest
        monthly_fcf = operating_income - monthly_debt
    ...
    def _estimate_new_pf_value(self):
        ...
        # 영업이익 (법인세 제거 - SPC 구조로 과세 이연)
        operating_income = monthly_revenue - OPEX_MONTHLY - monthly_interest
        monthly_fcf = operating_income - DEBT_MONTHLY_PAYMENT
        token_cf = monthly_fcf * TOKEN_SHARE
